      ...
      <div class="rpress-sidebar-cart-wrap">
		...
		<?php
			if(defined('RP_VERSION')) {
				if(version_compare(RP_VERSION, '2.6.2', '>=' )) {
				...
				<ul class="rpress-cart <?php echo ($cart_quantity > 0) ? 'not-empty-cart' : ''; ?>">
		...
		<fieldset id="rpress_checkout_login_register" class="rpress-checkout-account-wrap rpress-checkout-block">
			...
			<div class="rpress-checkout-button-actions">
				<div class="rp-col-md-4 rp-col-lg-4 rp-col-sm-6">
					...
					<a href="<?php echo esc_url( add_query_arg( 'login', 1 ) ); ?>" class="rpress_checkout_register_login rpress-submit button <?php echo esc_attr($color); ?>" data-action="rpress_checkout_login"><?php _e( 'Login', 'pearl' ); ?></a>
				</div>
				<div class="rp-col-md-8 rp-col-sm-6">
					<span><?php echo sprintf( __( 'New to %s?', 'pearl' ), get_bloginfo( 'name' ) ); ?></span>
					<a href="<?php echo esc_url( remove_query_arg('login') ); ?>" class="rpress_checkout_register_login rpress-submit button <?php echo esc_attr($color); ?>" data-action="rpress_checkout_register">
