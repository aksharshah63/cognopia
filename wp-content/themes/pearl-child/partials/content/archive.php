...
<div class="cm_search_content <?php echo esc_attr(implode(' ', $wrapper_classes)) ?>">
    ...
    if ('full' !== $sidebar_position) : ?>
        <div class="stm_markup__sidebar stm_markup__sidebar_divider stm_markup__sidebar_archive search_sidebar">
